...
SELECT e.FirstName, e.LastName, em.FirstName +' '+ em.LastName AS [Manager]
...
SELECT e.FirstName, e.LastName, em.FirstName +' ' + em.LastName AS [Manager], a.AddressText
FROM Employees e
JOIN Employees em
...
SELECT e.FirstName, e.LastName, em.FirstName + ' ' + em.LastName AS [Manager]  
FROM Employees e
RIGHT OUTER JOIN Employees em
ON e.ManagerID = em.ManagerID

--24. Write a SQL query to find the names of all employees from the departments "Sales" and "Finance" whose hire year is between 1995 and 2005.
SELECT e.FirstName, e.LastName, d.Name, e.HireDate
FROM Employees e, Departments d
WHERE (e.DepartmentID = d.DepartmentID AND (d.Name = 'Sales' OR d.Name = 'Finance')) 
